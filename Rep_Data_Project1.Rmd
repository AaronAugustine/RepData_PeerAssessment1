...
This document provides the results for Reproducible Research Assignment 1.  It will do this by answering a series of given questions using the provided R code.
...
```
The mean and median total number of adjusted steps per day is `r adjmeansteps` and `r adjmediansteps` respectively.
